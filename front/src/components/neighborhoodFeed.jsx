...
function NeighborhoodFeed() {
  ...
  useEffect(() => {
    ...
    const endpoint = showCreated ? `createdNeighborhood/${uid}` : `receivedNeighborhood/${uid}`;
  ...
  return (
    <div>
      ...
      <div className='button-container'>
        ...
        <button className="create-thread-button" onClick={() => navigate('/createThread', { state: { defaultReceiverType: 'neighborhood' } })}>
          Create Thread
        </button>
      </div>
